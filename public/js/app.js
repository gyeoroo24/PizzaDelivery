...
var addToCart = document.querySelectorAll('.add-to-cart'); //Selects the add button having class name add-to-cart
...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (res) {
    ...
    new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
      ...
      progressBar: false // layout : 'bottomLeft'    --For changing noty's position
...
addToCart.forEach(function (btn) {
  ...
  btn.addEventListener('click', function (e) {
    //event click , we get an event e and we 
    var pizza = JSON.parse(btn.dataset.pizza); //receive pizza from data-pizza value and as we sent json from home 
